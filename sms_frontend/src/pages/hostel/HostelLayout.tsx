...
const navItems = [
  { label: 'Dashboard', to: '/modules/hostel' },
  { label: 'Dormitories', to: '/modules/hostel/dormitories' },
  { label: 'Bed Spaces', to: '/modules/hostel/beds' },
  { label: 'Allocations', to: '/modules/hostel/allocations' },
  { label: 'Attendance', to: '/modules/hostel/attendance' },
  { label: 'Leave Requests', to: '/modules/hostel/leave' },
]
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans">
      <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-12 gap-4 px-4 py-6 sm:gap-6 sm:px-6 sm:py-8">
        <aside className="col-span-12 rounded-2xl glass-panel p-5 md:col-span-3 lg:col-span-2">
          <ModuleToolbar currentModule="HOSTEL" />
          <div className="mt-4">
            <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Hostel</p>
            <h2 className="mt-2 text-lg font-display font-semibold text-emerald-400">Management</h2>
          </div>
          <button
