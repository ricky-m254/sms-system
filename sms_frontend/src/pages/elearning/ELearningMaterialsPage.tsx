...
/* YouTube video IDs — real educational channels for Kenya CBC / KCSE */
const VIDEOS = [
  ...
  { id: 11, title: 'Biology — Genetics, DNA & Heredity (Form 3)', subject: 'Biology', level: 'Form 3', duration: '44:30', views: 1890, from: '#166534', to: '#22c55e', channel: 'Science Kenya', youtubeId: 'F0RiF3g6Tg8' },
  { id: 12, title: 'Physics — Pressure & Hooke\'s Law Experiments', subject: 'Physics', level: 'Form 2', duration: '32:15', views: 1120, from: '#0c4a6e', to: '#0ea5e9', channel: 'Physics Kenya', youtubeId: 'dQw4w9WgXcQ' },
]
...
const DOCUMENTS = [
  { id: 1, title: 'Form 3 Mathematics Notes — Complete', subject: 'Mathematics', type: 'Study Notes', size: '2.4 MB', pages: 48, uploaded: '3 Jan 2026' },
  { id: 2, title: 'Biology Practical Lab Manual 2026', subject: 'Biology', type: 'Lab Guide', size: '4.1 MB', pages: 62, uploaded: '5 Jan 2026' },
  { id: 3, title: 'Chemistry Revision Cards — Organic', subject: 'Chemistry', type: 'Revision Cards', size: '1.8 MB', pages: 32, uploaded: '7 Jan 2026' },
  { id: 4, title: 'Physics — Electromagnetism Summary Notes', subject: 'Physics', type: 'Study Notes', size: '1.5 MB', pages: 28, uploaded: '10 Jan 2026' },
  { id: 5, title: 'English Composition Model Essays', subject: 'English', type: 'Model Answers', size: '1.2 MB', pages: 24, uploaded: '12 Jan 2026' },
  { id: 6, title: 'Kiswahili Fasihi — Orodha ya Vitabu', subject: 'Kiswahili', type: 'Reading List', size: '0.8 MB', pages: 16, uploaded: '15 Jan 2026' },
  { id: 7, title: 'History Timeline — Colonial to Independence', subject: 'History', type: 'Timeline', size: '3.2 MB', pages: 40, uploaded: '18 Jan 2026' },
  { id: 8, title: 'Geography — Map Reading & Interpretation', subject: 'Geography', type: 'Study Notes', size: '2.8 MB', pages: 36, uploaded: '20 Jan 2026' },
  { id: 9, title: 'Computer Studies — Algorithm Design Notes', subject: 'Computer Studies', type: 'Study Notes', size: '1.9 MB', pages: 30, uploaded: '22 Jan 2026' },
  { id: 10, title: 'Mathematics — KCSE Formula Sheet', subject: 'Mathematics', type: 'Reference Sheet', size: '0.4 MB', pages: 4, uploaded: '25 Jan 2026' },
]
...
const PAPERS = [
  ...
  { id: 7, title: 'KCSE History 2024 Paper 1 & 2', subject: 'History', year: 2024, type: 'KCSE', size: '2.8 MB', markscheme: true },
  { id: 8, title: 'Form 3 End-Term Exam — Mathematics 2025', subject: 'Mathematics', year: 2025, type: 'School Exam', size: '0.9 MB', markscheme: false },
  { id: 9, title: 'Form 2 Mid-Term — Biology 2025', subject: 'Biology', year: 2025, type: 'School Exam', size: '0.7 MB', markscheme: false },
  { id: 10, title: 'Form 3 CAT 2 — Chemistry 2026', subject: 'Chemistry', year: 2026, type: 'School Exam', size: '0.6 MB', markscheme: false },
  { id: 11, title: 'Form 4 Mocks — All Subjects 2025', subject: 'Mathematics', year: 2025, type: 'School Exam', size: '8.4 MB', markscheme: true },
]
        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-2 mt-2">
            <span className="px-2 py-0.5 rounded-md text-xs font-semibold capitalize"
              style={{ background: 'rgba(239,68,68,0.15)', color: '#fca5a5' }}>{v.subject}</span>
          </div>
        </div>
      </a>
    </GlassCard>
            ...
            {filteredEbooks.map(b => (
              <GlassCard key={b.id} className="overflow-hidden hover:border-slate-600 cursor-pointer group p-0">
                ...
                <div className="p-3">
                  ...
                  <button className="mt-2 w-full py-1.5 rounded-lg text-xs font-semibold transition-all capitalize"
                    style={b.available
              ...
              <GlassCard key={d.id} className="p-4 hover:border-slate-600 cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-bold text-white truncate capitalize">{d.title}</p>
                    <p className="text-xs text-slate-400 capitalize">{d.subject} · {d.type}</p>
