...
const navItems = [
  { label: 'Dashboard', to: '/modules/transport/dashboard' },
  { label: 'Vehicles', to: '/modules/transport/vehicles' },
  { label: 'Routes', to: '/modules/transport/routes' },
  { label: 'Route Stops', to: '/modules/transport/stops' },
  { label: 'Student Assignments', to: '/modules/transport/students' },
  { label: 'Incidents', to: '/modules/transport/incidents' },
]
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans">
      <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-12 gap-4 px-4 py-6 sm:gap-6 sm:px-6 sm:py-8">
        <aside className="col-span-12 rounded-2xl glass-panel p-5 md:col-span-3 lg:col-span-2">
          <ModuleToolbar currentModule="TRANSPORT" />
          <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Transport</p>
