...
const navItems = [
  { label: 'Dashboard', to: '/modules/ptm' },
  { label: 'Sessions', to: '/modules/ptm/sessions' },
  { label: 'All Bookings', to: '/modules/ptm/bookings' },
  { label: 'My Slots', to: '/modules/ptm/my-slots' },
]

export default function PTMLayout() {
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans">
      <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-12 gap-4 px-4 py-6 sm:gap-6 sm:px-6 sm:py-8">
        <aside className="col-span-12 rounded-2xl glass-panel p-5 md:col-span-3 lg:col-span-2">
          <ModuleToolbar currentModule="PTM" />
          <div className="mt-4">
            <p className="text-xs uppercase tracking-[0.3em] text-slate-400">PTM</p>
